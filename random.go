...
// Returns a JSON summary of the current random statistics and resets the slot
// tally. 
...
// Creates a new Random. A random has a unique id, a random seed to ensure
// consistency when generating random numbers for the same seed, a percentage
// of required "good" samples and needs to know wheter to keep internal
// statistics.
